...
export default function AparaturSection() {
  ...
  const totalPages = Math.ceil(AparaturData.length / itemsPerPage);

  const startIndex = (currentPage - 1) * itemsPerPage;
  const currentData = AparaturData.slice(startIndex, startIndex + itemsPerPage);
